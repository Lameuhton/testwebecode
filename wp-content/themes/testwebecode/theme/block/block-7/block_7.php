    ...
    <section class="sides-page-margin flex flex-col md:grid md:grid-cols-12 gap-y-5 md:gap-y-0 md:gap-x-8 md:relative">
        ...
        <?php while (have_rows('content_blocks')): the_row(); ?>
            ...
            <?php if ($layout == 'rules_title'): ?>
                <div class="order-1 md:order-none md:col-start-5 col-end-12 row-start-1 lg:pl-2 text-left md:relative z-10 md:top-10">
                    <h2 class="font-bold text-primary"><?php echo $rules; ?></h2>
                </div>
            ...
            <?php elseif ($layout == 'main_title'): ?>
                <div class="block order-2 md:order-none md:col-start-5 col-end-12 row-start-1 lg:pl-2 text-left md:relative z-10 md:top-10">
